...
def addsongs():
    ...
    for s in temp_song:
        str=s.replace(r"C:\Users\GAURAV\Music player","")
...
def Play(self):
    ...
    song=r"C:\Users\GAURAV\Music player"
    mixer.init()
    mixer.music.load(self.song)
    mixer.music.play(self.song)
...
def Previous():
    ...
    temp2=r'C:\Users\GAURAV\Music player\song\{temp2}'
...
def Next():
    ...
    temp=r'C:\Users\GAURAV\Music player\song\{temp}'
...
songs_list=Listbox(root,selectmode=SINGLE,bg="grey",fg="white",font=('arial',15),height=12,width=47,selectbackground="gray",selectforeground="black")
